...
@Component({
  selector: 'app-lyricist-notes',
  standalone: true,
  imports: [FormsModule, CommonModule, RouterLink, HeaderComponent, FooterComponent],
  templateUrl: './lyricist-notes.component.html',
  styleUrl: './lyricist-notes.component.css'
})
export class LyricistNotesComponent implements OnInit {
